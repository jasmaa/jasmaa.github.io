...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'webGLTest.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 5763380;
      var PACKAGE_UUID = 'e954cf34-850e-42cc-969b-5c0bd18dd5b0';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 3367522, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(3367522, 3367543, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(3367543, 3368011, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(3368011, 4860783, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4860783, 5735755, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(5735755, 5763380, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_webGLTest.data');

    };
    Module['addRunDependency']('datafile_webGLTest.data');
